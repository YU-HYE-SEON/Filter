...
public interface UploadApi {
    ...
    @Multipart
    @POST("/api/v2/uploads/filters") // ⚠️ 주의: 서버 Controller의 @RequestMapping 경로를 확인해서 앞에 붙여주세요!
    ...
    @Multipart
    @POST("/api/v2/uploads/sticker-images") // 서버 Controller의 @RequestMapping 경로 확인 필요
    Call<String> uploadStickerImage(
