...
public class EditStickerFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View v, @Nullable Bundle savedInstanceState) {
        ...
        /// faceOverlay 위에 MyStickersFragment와 같은 stickerFrame 두기
        /// MyStickersFragment의 stickerFrame을 아예 faceOverlay 위로 올리기 가능?
        ...
        cancelBtn.setOnClickListener(view -> {
            ...
            // 프래그먼트 종료 후 직전 프래그먼트인 MyStickersFragment로 돌아감
