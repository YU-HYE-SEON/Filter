...
public class MyStickersFragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        boolean cameFromEdit =
                "mystickers_check".equals(EditMyStickerFragment2.sLastReturnOriginAction) ||
                        "mystickers_cancel".equals(EditMyStickerFragment2.sLastReturnOriginAction);

        if (cameFromEdit) {
            skipDisableOnce = true;
            EditMyStickerFragment2.sLastReturnOriginAction = null;
        }
        ...
        cancelBtn.setOnClickListener(v -> {
            ...
            requireActivity().getSupportFragmentManager()
                    ...
                    .replace(R.id.bottomArea2, new StickersFragment2())
                    .commit();
        });
