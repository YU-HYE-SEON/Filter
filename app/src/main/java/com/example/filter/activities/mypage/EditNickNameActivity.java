...
public class EditNickNameActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.a_edit_nickname);
        ...
        api.setNickname(body).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.e("닉네임변경", "❌ 닉네임 변경 실패: " + response.code());
                }
            }
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    try {
                        ...
                        Log.e("닉네임변경", "JSON 파싱 실패", e);
                    }
                } else {
                    Log.e("닉네임변경", "닉네임 중복 확인 실패 : " + response.code());
                }
            }

            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Log.e("닉네임변경", "닉네임 중복 확인 실패", t);
            }
        });
    }
