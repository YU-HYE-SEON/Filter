...
public class BrushCancelDialog extends Dialog {
    public interface BrushCancelDialogListener {
        void onNo();

        void onYes();
    }

    private BrushCancelDialogListener listener;

    public BrushCancelDialog(@NonNull Context context, BrushCancelDialogListener listener) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_cancel_brush);
